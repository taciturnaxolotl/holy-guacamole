...
def build_circuit():
    ...
    j_head.lcsc = "NONE"
    j_head.info = "External orange Tiny's LEDs 2-3S Micro LED heading marker: pin 1 switched 2S VBUS feed, pin 2 low-side switched return through Q1. Module is 2-3S capable with onboard current limiting; do not add series LED resistor unless the selected module variant requires it."
    ...
    j_esc.lcsc = "NONE"
    j_esc.info = "Signal harness to Repeat AM32 Dual Brushless Drive ESC: pin 1 GND, pin 2 DSHOT1/white channel bidirectional DSHOT+EDT, pin 3 DSHOT2/yellow channel bidirectional DSHOT+EDT, pin 4 GND. ESC BEC output is intentionally not connected to the carrier 5V rail in this revision."
    ...
    led.lcsc = "C2909059"
    led.info = "2x2mm APA102-compatible two-wire addressable LED. Powered from 5V; budget 61mA worst-case full white including control IC. Inputs are fed by 5V AHCT buffers because 5V CMOS VIH may exceed 3.3V."
